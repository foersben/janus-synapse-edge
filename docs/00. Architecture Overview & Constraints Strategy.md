...
flowchart TD
    ...
    subgraph MainCompute["Main Compute Node (Jonsbo Z20 Micro-ATX)"]
        direction TB
        Proxmox["Proxmox VE (ZFS Encrypted Bare Metal)"]:::hardware
...
- **Zero-Trust Bare Metal:** The foundational OS is Proxmox Virtual Environment. It runs no secondary services and is fully protected by ZFS-native AES-256 encryption.
