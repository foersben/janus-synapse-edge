...
flowchart TD
    ...
    subgraph External_NUC["External Intel NUC (UPS-Backed)"]
        DB["PostgreSQL/ClickHouse<br/>Kine External Datastore"]:::ext
    end
