...
3.  Simultaneously, TensorZero dispatches an API interrupt to Engine A and Engine B. Utilizing **RadixAttention**, the inference engines instantly evict the background agent's specific KV-Cache tree from the static VRAM fence.
