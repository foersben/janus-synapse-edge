...
2. **Visual Processing Reserve:** The multi-modal capabilities of Engine B (Qwen2-VL) are strictly reserved for literal, unparseable visual data (e.g., architectural diagrams, scientific charts, or embedded UI screenshots).
